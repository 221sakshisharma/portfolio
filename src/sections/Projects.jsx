...
const Projects = () => {
  ...
  return (
    <section id="projects" className='go-inside min-h-screen flex flex-col'>
      <AnimatedHeaderSection
              subtitle={"Crafted with passion, built to perform"} 
              title={"Projects"}
              text={"Explore my latest projects, where innovation meets execution."}
      ...
      <div
            ...
            >
              ...
              <div
                ref={previewRef}
                className="fixed -top-2 left-0 z-50 overflow-hidden border-5 border-black pointer-events-none w-[600px] md:block hidden opacity-0"
              >
                {currentIndex !== null && (
                  <img
